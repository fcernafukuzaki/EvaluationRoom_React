...
import {obtenerTextoBienvenida, obtenerTextoFinalizado, obtenerValorParametro} from './Mensajes';
	...
	seleccionarAlternativa(idAlternativa, indiceAlternativa){
		...
		if(this.state.mensajeContador.mensaje == "Se acabó el tiempo. Debe pasar al siguiente test presionando el botón SIGUIENTE"){
			...
			if(this.state.respuestas.length >= cantMaxAlt[0].alternativaMaxSeleccion){
				...
				//console.log('seleccionarAlternativa:;;;;;;;;;;;;;;;;;;;;;;', this.state);
				//console.log('seleccionarAlternativa:;;;;;;;;;;;;;;;;;;;;;;', this.state.mensajeContador);
				this.alternativaSeleccionada(idAlternativa);
			}
		}
		//console.log('seleccionarAlternativa', this.state.respuestas);
	}
	...
	render() {
		...
		return(
			<a-scene cursor="rayOrigin: mouse">
				...
				<a-grid position="0 -0.070 0" visible="false" static-body></a-grid>
				...
				<a-entity id="presentador" gltf-model="url(assets/personaje/presentador.gltf)"
					animation-mixer="clip: idle;"
					position="0.17 0 -0.28"
					rotation="0 45 0"
