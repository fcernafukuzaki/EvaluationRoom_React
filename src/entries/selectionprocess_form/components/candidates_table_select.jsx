...
class CandidatesTableSelect extends Component {
	constructor(props){
		super(props);
		this.state = {
...
export default connect(mapStateToProps, { obtenerCandidatos, obtenerCliente, guardarPuestoLaboralCandidato, eliminarPuestoLaboralCandidato, obtenerPuestoLaboralCandidato, generarInforme })(CandidatesTableSelect);